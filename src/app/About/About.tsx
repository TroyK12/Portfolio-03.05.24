...
export default function About() {
    ...
    return (
        <div className='flex flex-col items-center overflow-y-scroll h-[60%] px-4'>
            ...
            <p>
                My adventure starts in the heart of the Middle East, serving my county as a satelite specialist in the summer of 2021. I specialised in the operation and maintence of our
