	...
	return (
		<motion.div
			...
			<motion.div
				...
				variants={variants}
				className={`relative ${
					isHovered ? styles.imageDropshadowWhite : styles.imageDropshadow
				} overflow-hidden rounded-xl ease-in-out duration-500 group`}
				...
				<div className="w-full h-[50%] flex justify-end pt-14">
					<div className="relative w-[65%] flex justify-end aspect-video overflow-hidden ease-in-out duration-1000 group-hover:scale-[1.1] group-hover:translate-y-[-10px] group-hover:translate-x-[-5px]">
						<Image
							...
							alt="laptop"
							width={200}
							className="absolute right-0 z-[1] w-[75%]"
						/>
						<div className="w-full h-full pt-4">
							<Image
								...
								alt="page"
								width={200}
								className="w-[61.5%] absolute left-[32%]"
							/>
						</div>
					</div>
					<div className="relative flex justify-center justify-self-start w-[35%] ease-in-out duration-1000 group-hover:scale-[1.1] group-hover:translate-y-[-10px] group-hover:translate-x-[5px]">
						<Image
							...
							alt="phone"
							width={200}
							className="absolute z-[2] left-0 w-[43%]"
						/>
				...
				<Link target="_blank" rel="noopener noreferrer" href={project.src}>
					{isHovered && (
						<button
							style={{
							...
							className={`hidden md:block absolute z-[11] w-[150px] h-[150px] rounded-full text-sm blur-2xl shadow-2xl duration-100 whitespace-normal`}>
							Visit {project.name}!
						</button>
					)}
				</Link>
				<div className="flex flex-col items-center justify-center p-7">
					<h3 className="text-sm sm:text-base md:text-xl font-extrabold text-[#fff] mix-blend-difference">
						{project.title}
					</h3>
					<p className="text-xs sm:text-sm font-mono py-5 tracking-widest leading-6">
						{project.desc}
					</p>
				</div>
			</motion.div>
