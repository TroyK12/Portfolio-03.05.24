        ...
        <div className="h-screen w-screen relative">
            <div className="h-full w-full flex flex-col-reverse md:flex-row">
                <div className="w-full md:w-1/2 flex flex-col justify-between px-8 pt-5 md:pt-[15vh]">
                    <div>
                        <Image src={selfPhoto} alt="Self Photo" width={100} className="w-[100px] md:w-[130px] rounded-full mb-2" />
                        <h2 className="md:text-4xl font-thin whitespace-break-spaces">t r o y k u s h @ g m a i l . c o m</h2>
                    </div>
                    <h2 className="text-xs font-mono">2024 &copy; TKM Webcreations LLC</h2>
                </div>
